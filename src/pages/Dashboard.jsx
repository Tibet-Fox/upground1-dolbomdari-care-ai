        ...
        try {
          ...
          if (questions && questions.length > 0) {
            ...
            const defaultSuggestions = {
              ...
              7: [
                "Q1. AI 챗봇의 응답 오류 및 피드백은 어떻게 하나요?",
                "Q2. AI 챗봇 답변이 잘못되었을 때는 어떻게 하나요?",
                "Q3. AI 챗봇 개선 제안은 어떻게 할 수 있나요?",
                "Q4. AI 챗봇 사용 중 문제가 발생하면 어떻게 하나요?"
              ]
            };
  ...
  const handleSuggestionClick = async (suggestion) => {
    ...
    try {
      ...
      if (!botResponse) {
        ...
        } else if (categoryId === 7) { // AI 챗봇의 응답 오류 및 피드백
          if (keywords.includes('오류') && keywords.includes('피드백')) {
            botResponse = {
              greeting: "AI 챗봇의 응답 오류 및 피드백에 대해 상세히 안내드릴게요!",
              summary: "AI 챗봇의 응답에 오류가 있거나 개선이 필요한 경우 피드백을 제공하여 더 나은 서비스를 제공합니다.",
              explanation: "AI 챗봇의 응답 오류 및 피드백은 다음과 같습니다:\n\n🚨 **오류 유형**\n• **정보 오류**: 잘못된 정보 제공\n• **답변 누락**: 질문에 대한 답변 누락\n• **불완전한 답변**: 부분적인 답변만 제공\n• **이해 오류**: 질문을 잘못 이해한 경우\n• **기술적 오류**: 시스템 오류나 접속 문제\n\n📝 **피드백 방법**\n• **즉시 피드백**: 답변 하단의 피드백 버튼\n• **상세 피드백**: 오류 내용 상세 작성\n• **스크린샷**: 오류 상황 스크린샷 첨부\n• **이메일**: 이메일로 상세 피드백 전송\n• **전화**: 긴급한 경우 전화 상담\n\n🔧 **피드백 처리**\n• **즉시 검토**: 피드백 접수 즉시 검토\n• **전문가 검토**: 관련 전문가의 검토\n• **수정 적용**: 오류 수정 후 즉시 적용\n• **사용자 통보**: 수정 완료 시 사용자 통보\n• **품질 개선**: 지속적인 품질 개선\n\n📊 **피드백 통계**\n• **처리 시간**: 평균 24시간 이내 처리\n• **해결률**: 95% 이상의 문제 해결\n• **만족도**: 피드백 처리 후 만족도 조사\n• **개선 효과**: 피드백 기반 지속적 개선\n\n⚠️ **피드백 시 주의사항**\n• **구체적 설명**: 오류 내용을 구체적으로 설명\n• **증거 자료**: 가능한 증거 자료 첨부\n• **건설적 제안**: 개선 방안 제안\n• **정중한 표현**: 정중하고 건설적인 표현\n• **개인정보 보호**: 민감한 개인정보 제외\n\n💡 **효과적인 피드백**\n• **즉시 신고**: 오류 발견 즉시 신고\n• **상세 기록**: 오류 상황 상세 기록\n• **재현 방법**: 오류 재현 방법 설명\n• **개선 제안**: 구체적인 개선 방안 제안\n• **지속적 모니터링**: 정기적인 사용 후기 제공",
              references: [
                { title: "AI 챗봇 피드백 가이드", url: "/documents/ai-chatbot-feedback-guide.pdf" }
              ]
            };
          } else if (keywords.includes('답변') && keywords.includes('잘못')) {
            botResponse = {
              greeting: "AI 챗봇 답변이 잘못되었을 때 대처 방법에 대해 상세히 안내드릴게요!",
              summary: "AI 챗봇 답변이 잘못되었을 때는 즉시 피드백을 제공하고, 정확한 정보를 확인할 수 있는 방법을 안내합니다.",
              explanation: "AI 챗봇 답변이 잘못되었을 때 대처 방법은 다음과 같습니다:\n\n🚨 **즉시 대처 방법**\n• **피드백 버튼 클릭**: 답변 하단의 피드백 버튼 클릭\n• **오류 내용 기록**: 잘못된 내용을 구체적으로 기록\n• **정확한 정보 제공**: 알고 있는 정확한 정보 제공\n• **스크린샷 첨부**: 잘못된 답변 화면 캡처\n\n📝 **피드백 작성 방법**\n• **구체적 설명**: 어떤 부분이 잘못되었는지 구체적으로 설명\n• **정확한 정보**: 올바른 정보나 답변 제시\n• **출처 명시**: 정확한 정보의 출처나 근거 제시\n• **개선 제안**: 더 나은 답변을 위한 제안\n\n🔍 **정확한 정보 확인 방법**\n• **공식 자료 확인**: 공단 홈페이지나 공식 자료 확인\n• **담당자 상담**: 복잡한 사안은 담당자와 상담\n• **다중 확인**: 여러 자료로 교차 확인\n• **전문가 의견**: 관련 전문가의 의견 수렴\n\n⚠️ **주의사항**\n• **즉시 신고**: 잘못된 답변 발견 즉시 신고\n• **정확한 정보**: 확실하지 않은 정보는 제외\n• **건설적 제안**: 비판보다는 개선 제안\n• **정중한 표현**: 정중하고 건설적인 표현 사용\n\n💡 **예방 방법**\n• **정기적 확인**: 정기적으로 답변 내용 확인\n• **피드백 제공**: 오류 발견 시 적극적 피드백\n• **개선 참여**: 서비스 개선에 적극 참여\n• **정보 공유**: 정확한 정보 공유",
              references: [
                { title: "AI 챗봇 오류 대처 가이드", url: "/documents/ai-chatbot-error-handling-guide.pdf" }
              ]
            };
          } else if (keywords.includes('개선') && keywords.includes('제안')) {
            botResponse = {
              greeting: "AI 챗봇 개선 제안 방법에 대해 상세히 안내드릴게요!",
              summary: "AI 챗봇 서비스 개선을 위한 제안은 언제든지 가능하며, 모든 제안은 검토 후 반영됩니다.",
              explanation: "AI 챗봇 개선 제안 방법은 다음과 같습니다:\n\n💡 **개선 제안 분야**\n• **답변 품질**: 더 정확하고 상세한 답변\n• **사용자 경험**: 더 편리한 사용 방법\n• **기능 추가**: 새로운 기능이나 서비스\n• **디자인 개선**: UI/UX 개선 사항\n• **성능 향상**: 속도나 안정성 개선\n\n📝 **제안 방법**\n• **피드백 버튼**: 답변 하단의 피드백 버튼\n• **이메일 제안**: 이메일로 상세한 제안서 작성\n• **설문조사**: 정기적인 사용자 만족도 조사\n• **전화 상담**: 긴급하거나 복잡한 제안\n• **온라인 포럼**: 사용자 커뮤니티 참여\n\n🔧 **제안 처리 과정**\n• **접수 확인**: 제안 접수 즉시 확인 메시지\n• **검토 과정**: 관련 부서의 상세 검토\n• **타당성 평가**: 기술적, 경제적 타당성 평가\n• **개발 계획**: 우선순위에 따른 개발 계획 수립\n• **적용 및 통보**: 개선사항 적용 후 사용자 통보\n\n📊 **제안 통계**\n• **접수 건수**: 월 평균 100건 이상\n• **적용률**: 약 30%의 제안이 실제 적용\n• **처리 기간**: 평균 2주~1개월\n• **사용자 만족도**: 적용 후 만족도 90% 이상\n\n⚠️ **제안 시 주의사항**\n• **구체적 제안**: 구체적이고 실현 가능한 제안\n• **근거 제시**: 제안의 필요성과 효과에 대한 근거\n• **정중한 표현**: 정중하고 건설적인 표현\n• **현실적 기대**: 기술적 한계 고려한 현실적 기대\n\n💡 **효과적인 제안 방법**\n• **문제점 파악**: 현재 서비스의 문제점 정확히 파악\n• **해결방안 제시**: 구체적인 해결방안 제시\n• **효과 예측**: 개선 후 예상되는 효과 설명\n• **단계적 접근**: 단계적이고 점진적인 개선 제안",
              references: [
                { title: "AI 챗봇 개선 제안 가이드", url: "/documents/ai-chatbot-improvement-guide.pdf" }
              ]
            };
          } else if (keywords.includes('문제') && keywords.includes('발생')) {
            botResponse = {
              greeting: "AI 챗봇 사용 중 문제 발생 시 대처 방법에 대해 상세히 안내드릴게요!",
              summary: "AI 챗봇 사용 중 문제가 발생하면 즉시 신고하고, 대안을 제공하여 서비스 중단 없이 도움을 받을 수 있습니다.",
              explanation: "AI 챗봇 사용 중 문제 발생 시 대처 방법은 다음과 같습니다:\n\n🚨 **즉시 대처 방법**\n• **페이지 새로고침**: 브라우저 새로고침으로 재시작\n• **브라우저 재시작**: 브라우저를 완전히 종료 후 재시작\n• **캐시 삭제**: 브라우저 캐시 및 쿠키 삭제\n• **다른 브라우저**: 다른 브라우저로 접속 시도\n\n📞 **긴급 연락처**\n• **고객센터**: 1588-0000 (24시간 운영)\n• **이메일**: support@dolbomdari.com\n• **카카오톡**: @돌봄다리고객센터\n• **전화**: 평일 09:00~18:00\n\n🔧 **기술적 문제**\n• **접속 오류**: 서버 점검 중일 수 있음\n• **답변 지연**: 네트워크 상태 확인\n• **화면 오류**: 브라우저 호환성 문제\n• **데이터 손실**: 자동 저장 기능 확인\n\n📋 **문제 신고 방법**\n• **상세 기록**: 문제 상황을 상세히 기록\n• **스크린샷**: 문제 상황 스크린샷 첨부\n• **재현 방법**: 문제 재현 방법 설명\n• **환경 정보**: 브라우저, OS 정보 제공\n\n⚠️ **주의사항**\n• **개인정보 보호**: 민감한 개인정보는 제외\n• **즉시 신고**: 문제 발견 즉시 신고\n• **대안 활용**: 문제 해결 전 대안 서비스 활용\n• **정기 확인**: 정기적으로 서비스 상태 확인\n\n💡 **예방 방법**\n• **정기 업데이트**: 브라우저 정기 업데이트\n• **안정적 네트워크**: 안정적인 인터넷 환경\n• **백업 데이터**: 중요한 정보는 별도 저장\n• **대안 준비**: 여러 접속 방법 준비",
              references: [
                { title: "AI 챗봇 문제 해결 가이드", url: "/documents/ai-chatbot-troubleshooting-guide.pdf" }
              ]
            };
          }
        } else {
